...
1. `[active-business]/brand.md` (Section 4: Brand Voice) — your brand context (for comparison if auditing your own site)
...
If no URL is provided, check if the brand's brand.md contains a website URL and offer to audit that.
...
Save to: `[active-business]/output/research/website-audit-YYYY-MM-DD.md`
