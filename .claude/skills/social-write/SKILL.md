...
**Batch mode:** Check `[active-business]/output/social/plans/` for the most recent weekly plan. If one exists for the current or upcoming week, ask: "I found your plan for week of [date]. Want me to write posts from this plan?"
...
In standalone mode, check `[active-business]/content-ideas.md` if it exists. Scan "Ready to Write" for ideas matching the target platform (use platform tags: `[TW]` for X, `[LI]` for LinkedIn, `[FB]` for Facebook, `[IG]` for Instagram, `[ALL]` for any).
...
### All Platforms
- Match the brand's voice (from brand.md Section 4)
...
- `[active-business]/output/social/x/YYYY-MM-DD-slug.md`
- `[active-business]/output/social/linkedin/YYYY-MM-DD-slug.md`
- `[active-business]/output/social/facebook/YYYY-MM-DD-slug.md`
...
After saving:
- If any posts were based on content bank ideas, mark them as `[SCHEDULED YYYY-MM-DD]` in `[active-business]/content-ideas.md` or move to "Used" if they're now complete.
