...
1. `brands/[active-brand]/voice.md` — understand their brand and business
2. `brands/[active-brand]/lessons.md` — past decisions and context
3. Audience personas from `brands/[active-brand]/audiences/` — who they're serving
...
"Want me to save this? I can put it at `brands/[active-brand]/output/research/strategy-YYYY-MM-DD.md`."
