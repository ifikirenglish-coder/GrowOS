...
Load `brands/[active-brand]/content-ideas.md` if it exists. Scan the "Ready to Write" section for ideas tagged `[NL]` or `[ALL]`. Present the top 3 most timely ideas as starting points (sorted by "Why now" relevance).
...
1. `brands/[active-brand]/stories/_index.md` — personal stories that could become emails
2. `brands/[active-brand]/output/` — recent content that could be repurposed
3. Recent industry trends or common audience pain points from `brands/[active-brand]/audiences/`
...
- **Conversational tone.** Match the brand's voice.md exactly.
...
- **Sign off** using the brand's preferred sign-off from voice.md.
...
Save the draft to: `brands/[active-brand]/output/newsletters/drafts/YYYY-MM-DD-slug.md`
...
If the newsletter was based on an idea from `brands/[active-brand]/content-ideas.md`, move that idea from "Ready to Write" to the "Used" section with today's date and format note:
...
2. Add a concise, actionable rule to `brands/[active-brand]/lessons.md` under the newsletters section
