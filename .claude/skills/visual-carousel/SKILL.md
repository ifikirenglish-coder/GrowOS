...
1. Load `[active-business]/brand.md (Section 4: Brand Voice)` for brand colors, fonts, tone, and visual style.
2. Load `[active-business]/lessons.md` for any carousel or social media lessons.
...
- Use brand colors and fonts from brand.md Section 4 (Brand Voice)
...
Save to `[active-business]/output/social/carousels/[date]-[slug]/`:
