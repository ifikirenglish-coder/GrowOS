...
Load the target audience persona from `brands/[active-brand]/audiences/`.
...
- Match the brand's voice.md exactly
...
Save to: `brands/[active-brand]/output/ads/YYYY-MM-DD-campaign-slug/`
...
1. Apply the changes
2. Add a concise, actionable rule to `brands/[active-brand]/lessons.md` under the ads section
