...
3. The relevant audience persona from `[active-business]/audiences/` (ask which one if not obvious)
...
- `[active-business]/output/lead-magnets/YYYY-MM-DD-slug/content.md` — the actual lead magnet
- `[active-business]/output/lead-magnets/YYYY-MM-DD-slug/landing-page-copy.md` — the opt-in page text
