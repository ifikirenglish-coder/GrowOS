...
**Output:** Reports in `brands/[active-brand]/output/competitor-intelligence/`, scraped data in `brands/[active-brand]/competitors/[slug]/`
...
Save to `brands/[active-brand]/competitors/[competitor-slug].md`:
...
Read `brands/[active-brand]/competitors/_index.md`. Add the new competitor entry:
...
1. `brands/[active-brand]/voice.md` — brand voice and positioning
2. `brands/[active-brand]/lessons.md` — rules from past feedback
3. `brands/[active-brand]/competitors/_index.md` — all tracked competitors
4. `brands/[active-brand]/content-ideas.md` — existing content ideas (for deduplication)
...
"Playwright is needed for scraping. Install it with: `npm install playwright && npx playwright install chromium`"
...
For each selected competitor, read their profile from `brands/[active-brand]/competitors/[slug].md` to get platform handles.
...
6. Save to `brands/[active-brand]/competitors/[slug]/twitter-YYYY-MM.md`:
...
4. Save to `brands/[active-brand]/competitors/[slug]/linkedin-YYYY-MM.md` using the same monthly format. Use content hash for dedup anchors since LinkedIn post IDs are harder to capture:
   ```
   <!-- post:hash:ABCD1234 -->
   ```
...
3. Save to `brands/[active-brand]/competitors/[slug]/youtube-YYYY-MM.md`:
...
Save to `brands/[active-brand]/output/competitor-intelligence/YYYY-MM-DD-report.md`:
...
For each selected idea, add to `brands/[active-brand]/content-ideas.md` in the Ready to Write section:
...
For each scraped competitor, update their profile at `brands/[active-brand]/competitors/[slug].md`:

- Set "Last scraped" to today's date
- Add or update "Key Insights" section with 2-3 bullet points from the analysis
- Update the entry in `brands/[active-brand]/competitors/_index.md` with the new last-scraped date
...
Report saved: brands/[active-brand]/output/competitor-intelligence/YYYY-MM-DD-report.md
```
...
2. Add a concise rule to `brands/[active-brand]/lessons.md` under a "Competitor Intelligence" section
