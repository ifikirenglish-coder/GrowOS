...
1. Load `[active-business]/brand.md (Section 4: Brand Voice)` for brand colors, fonts, and tone.
2. Load `[active-business]/lessons.md` for any animation or video lessons.
...
- Typography: use brand heading and body fonts from brand.md Section 4 (Brand Voice)
...
- Rendered files: `[active-business]/output/video/{project-slug}/`

**If Remotion NOT available:**
- Brief: `[active-business]/output/video/[date]-[slug]-animation-brief.md`
