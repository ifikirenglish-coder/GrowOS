...
1. `[active-business]/brand.md` (Section 4: Brand Voice) — writing voice (for any last-minute checks)
...
Check `[active-business]/output/social/` for recent post files that are not yet marked as scheduled.
