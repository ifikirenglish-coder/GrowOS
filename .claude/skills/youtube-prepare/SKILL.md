...
Load `[active-business]/content-ideas.md` if it exists. Scan the "Ready to Write" section for ideas tagged `[VID]` or `[ALL]`. Present the top options as starting points.
...
1. `[active-business]/audiences/` — what problems does the audience care about?
2. `[active-business]/output/` — recent content that could become a video
...
- Conversational language matching brand.md Section 4 (Brand Voice)
...
Save to: `[active-business]/output/youtube/YYYY-MM-DD-slug/`
...
If the video was based on an idea from `[active-business]/content-ideas.md`, mark that idea as `[SCHEDULED YYYY-MM-DD]` in the Ready to Write section. (Don't move to Used yet, since the video still needs to be filmed and published.)
