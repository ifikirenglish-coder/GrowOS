...
- Match the brand's brand.md Section 4 (Brand Voice).
- No em dashes.
...
Save all output to: `[active-business]/output/repurposed/YYYY-MM-DD-slug/`
...
2. Add a concise, actionable rule to `[active-business]/lessons.md` under the repurposing section
