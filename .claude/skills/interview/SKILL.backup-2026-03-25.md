...
1. `brands/[active-brand]/voice.md` — writing voice (for the final document)
2. `brands/[active-brand]/lessons.md` — relevant rules and context
...
- General specs: `brands/[active-brand]/output/research/spec-YYYY-MM-DD-slug.md`
- Offer specs: `brands/[active-brand]/output/offers/[name]/spec.md`
- Content specs: `brands/[active-brand]/output/research/spec-YYYY-MM-DD-slug.md`
