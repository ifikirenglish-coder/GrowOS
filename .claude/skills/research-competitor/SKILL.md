...
1. `[active-business]/brand.md` (Section 4: Brand Voice) — your brand positioning
2. `[active-business]/lessons.md` — rules from past feedback
3. `[active-business]/brand.md` (Section 5: Competitors) — existing competitor intel
...
**If "find my competitors":** Use the brand's brand.md (Section 4: Brand Voice) and audience files to understand the niche. Search for competitors in that space. Present 5-7 potential competitors and let the user pick which to analyze.
...
Compare against your brand's positioning (from brand.md Section 4: Brand Voice and audience files):
...
Add or update the competitor in `[active-business]/brand.md` (Section 5: Competitors):

Add a summary entry with:
- **Name and URL**
- **Analyzed date**
...
Save to: `[active-business]/output/research/competitor-[name]-YYYY-MM-DD.md`
...
1. Apply the changes
2. Add a concise, actionable rule to `[active-business]/lessons.md` under the research section
