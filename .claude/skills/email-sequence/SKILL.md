...
Load the target audience from `[active-business]/audiences/` if available.

If a launch sequence references an offer, check `[active-business]/output/offers/` for existing offer docs.
...
- Sign-off should match what's in brand.md Section 4 (Brand Voice)
...
Save to `[active-business]/output/newsletter/YYYY-MM-DD-slug/`
