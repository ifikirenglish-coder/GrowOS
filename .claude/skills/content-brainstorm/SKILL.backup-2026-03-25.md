...
**Output:** Ideas saved to `brands/[active-brand]/content-ideas.md`, ready to pick from when creating content.
...
3. `brands/[active-brand]/audiences/` — who you're writing for
4. `brands/[active-brand]/content-ideas.md` — current content bank (create from template if it doesn't exist)

If `content-ideas.md` doesn't exist yet, copy from `brands/_template/content-ideas.md` to `brands/[active-brand]/content-ideas.md`.
...
Load `brands/[active-brand]/content-ideas.md` and analyze:
...
Save ideas to `brands/[active-brand]/content-ideas.md`:
