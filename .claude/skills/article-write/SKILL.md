...
Load `[active-business]/content-ideas.md` if it exists. Scan the "Ready to Write" section for ideas tagged `[ART]` or `[ALL]`. Present the top options as starting points.
...
Load `[active-business]/audiences/` if they mention a specific persona.

If they reference competitors or want to differentiate, check `[active-business]/brand.md` Section 5 for positioning context.
...
- Conversational tone throughout (match brand.md Section 4)
- No em dashes
...
Save to `[active-business]/output/blog/YYYY-MM-DD-slug/`
...
If the article was based on an idea from `[active-business]/content-ideas.md`, move that idea from "Ready to Write" to the "Used" section with today's date:
